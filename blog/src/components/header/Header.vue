    ...
    <div id="bai-viet-moi-nhat" class="container vue-tempalte">
        ...
        <nav class="navbar shadow bg-white rounded justify-content-between flex-nowrap flex-row fixed-top">
            <div class="container">
                    ...
                    <span class="create-article">   
                        <router-link :to="{name:'createpost'}" class="text-primary" v-if="isLoggedIn">
                    ...
                    <div class="topnav search-container" ref="searchToggle">
                            ...
                            <button @click="searchPost()" type="button" class="icon-search"><i class="fa fa-search"></i></button>
                            <button @click="searchPost()" type="button" class="text-search">Tìm kiếm</button>
                    ...
                    <ul class="nav navbar-nav flex-row float-right">
                        <span v-if="isLoggedIn">
                            <li class="nav-item position-relative w-100 ml-1">
                                ...
                                style="width:30px;
                                height:30px;
                                font: 15px / 33px Helvetica, Arial, sans-serif;
